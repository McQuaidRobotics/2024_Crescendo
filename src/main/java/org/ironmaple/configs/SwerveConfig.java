 ...
 */
public class SwerveConfig extends DriveTrainSimulationConfig<SimDriveTrainSwerve, SwerveConfig> {
     ...
     */
    public SwerveConfig withModuleTranslations(Translation2d[] moduleTranslations) {
        this.moduleTranslations = moduleTranslations;
        return this;
    }
