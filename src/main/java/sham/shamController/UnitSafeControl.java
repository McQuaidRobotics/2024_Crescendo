...
public class UnitSafeControl {
    ...
    public static class PIDFeedback<O extends Unit, Q extends Unit> {
        ...
        public PIDFeedback(
            ...
            internalController = new edu.wpi.first.math.controller.PIDController(
                    kP.baseUnitMagnitude(),
                    kI.baseUnitMagnitude(),
                    kD.baseUnitMagnitude());
        }
        ...
        public PIDFeedback(
            ...
            outputUnit = kP.unit().numerator();
            inputUnit = kP.unit().denominator();
            internalController = new edu.wpi.first.math.controller.PIDController(kP.baseUnitMagnitude(), 0.0,
                    kD.baseUnitMagnitude());
        }
        ...
        public PIDFeedback<O, Q> withTolerance(Measure<Q> positionTolerance, Measure<Q> velocityTolerance) {
            internalController.setTolerance(positionTolerance.baseUnitMagnitude(),
                    velocityTolerance.baseUnitMagnitude());
            return this;
        }

        public PIDFeedback<O, Q> withContinuousInput(Measure<Q> minimumInput, Measure<Q> maximumInput) {
            internalController.enableContinuousInput(minimumInput.baseUnitMagnitude(),
                    maximumInput.baseUnitMagnitude());
            return this;
        }
    ...
    public static class LinearPIDFeedback<O extends Unit> extends PIDFeedback<O, DistanceUnit> {
        ...
        public LinearPIDFeedback(
            ...
            super(
                    ...
                    PerUnit.combine(
                            kD.unit().numerator(),
                            VelocityUnit.combine(Meters, Second)).ofNative(kD.baseUnitMagnitude()));
        }
        ...
        public Pair<Measure<O>, Measure<DistanceUnit>> calculate(Distance measurement, Distance setpoint) {
            return super.calculate(measurement, setpoint);
        }
    }

    public static class LinearVelocityPIDFeedback<O extends Unit> extends PIDFeedback<O, LinearVelocityUnit> {
        public LinearVelocityPIDFeedback(
            ...
            super(
                    ...
                    PerUnit.combine(
                            kD.unit().numerator(),
                            VelocityUnit.combine(MetersPerSecond, Second)).ofNative(kD.baseUnitMagnitude()));
        }

        public LinearVelocityPIDFeedback(
                Per<O, LinearVelocityUnit> kP,
                Per<O, PerUnit<LinearVelocityUnit, TimeUnit>> kD) {
            super(
                    kP,
                    PerUnit.combine(
                            kD.unit().numerator(),
        ...
        public Pair<Measure<O>, Measure<LinearVelocityUnit>> calculate(LinearVelocity measurement,
                LinearVelocity setpoint) {
            return super.calculate(measurement, setpoint);
        }
    }
    ...
    public static class AngularPIDFeedback<O extends Unit> extends PIDFeedback<O, AngleUnit> {
        ...
        public AngularPIDFeedback(
            ...
            super(
                    ...
                    PerUnit.combine(
                            kD.unit().numerator(),
                            VelocityUnit.combine(Radian, Second)).ofNative(kD.baseUnitMagnitude()));
        }
    ...
    public static class AngularVelocityPIDFeedback<O extends Unit> extends PIDFeedback<O, AngularVelocityUnit> {
        public AngularVelocityPIDFeedback(
            ...
            super(
                    ...
                    PerUnit.combine(
                            kD.unit().numerator(),
                            VelocityUnit.combine(RadiansPerSecond, Second)).ofNative(kD.baseUnitMagnitude()));
        }
        ...
        public Pair<Measure<O>, Measure<AngularVelocityUnit>> calculate(AngularVelocity measurement,
    ...
    public static final class FlywheelFeedforward<O extends Unit> implements Feedforward<O, AngleUnit> {
        ...
        public Measure<O> calculate(AngularVelocity goalRate, AngularVelocity nextGoalRate) {
            return (Measure<O>) outputUnit.of(
                    internalFeedforward.calculateWithVelocities(goalRate.baseUnitMagnitude(),
    ...
    public static final class ElevatorFeedforward<O extends Unit> implements Feedforward<O, DistanceUnit> {
    ...
    public static final class ArmFeedforward<O extends Unit> implements Feedforward<O, AngleUnit> {
        ...
        public Measure<O> calculate(Angle currentAngle, AngularVelocity goalRate,
                AngularAcceleration goalRateRate) {
            return (Measure<O>) outputUnit.of(
        ...
        public Measure<O> calculate(Angle currentAngle, AngularVelocity goalRate, AngularVelocity nextGoalRate) {
            return (Measure<O>) outputUnit.of(
                    internalFeedforward.calculateWithVelocities(currentAngle.baseUnitMagnitude(),
    ...
    public static class TrapezoidProfile<DIM extends Unit> {
        ...
        public record State<DIM extends Unit>(
                Measure<DIM> value,
                Velocity<DIM> slew) implements StructSerializable {
