...
public record SwerveSetpoint(
    ...
    public static SwerveSetpoint zeroed() {
        return new SwerveSetpoint(RobotSpeeds.kZero, new AdvancedSwerveModuleState[] {
    ...
    public static final Struct<SwerveSetpoint> struct = ProceduralStructGenerator.genRecord(SwerveSetpoint.class);
}
