...
public class ErrorHelper {
    ...
    /**
     * An object containing always 1 of 2 potential values.
     * <p>
     * The generic types define what the result can contain,
     * the first type is the "ok" value type(no constraints), the second is the
     * "err" value type(has to implement {@link Error}).
     */
