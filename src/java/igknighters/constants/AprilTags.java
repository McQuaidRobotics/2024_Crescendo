...
public class AprilTags {
  public static final AprilTag[] APRILTAGS =
      new AprilTag[] {
        ...
        new AprilTag(
            15,
            new Pose3d(new Translation3d(182.73, 177.10, 52.00), new Rotation3d(0.0, 0.0, 120))),
        new AprilTag(
            16, new Pose3d(new Translation3d(182.73, 146.19, 52.00), new Rotation3d(0.0, 0.0, 240)))
      };
}
