...
public class StemVisualizer {
  ...
  public StemVisualizer() {
    ...
    telescopeCurrent =
        rootCurrent.append(
            new MechanismLigament2d("Telescope Current", kTelescope.MIN_METERS, 0.0));
    wristCurrent =
        telescopeCurrent.append(
    ...
    telescopeSetpoint =
        rootSetpoint.append(
            new MechanismLigament2d("Telescope Setpoint", kTelescope.MIN_METERS, 0.0));
    wristSetpoint =
        telescopeSetpoint.append(
            new MechanismLigament2d(
    ...
    if (Robot.isDebug()) {
      var table = NetworkTableInstance.getDefault().getTable("Visualizers").getSubTable("Stem");
  ...
  private void drawUmbrella(MechanismLigament2d wristRoot, boolean isSetpoint) {
    MechanismLigament2d leftSide =
        wristRoot.append(
            new MechanismLigament2d(
                "Umbrella Left Side", kRobotCollisionGeometry.UMBRELLA_HEIGHT, 0.0));
    MechanismLigament2d topSide =
        leftSide.append(
            new MechanismLigament2d(
                "Umbrella Top Side", kRobotCollisionGeometry.UMBRELLA_LENGTH, -90.0));
    MechanismLigament2d rightSide =
        topSide.append(
            new MechanismLigament2d(
                "Umbrella Right Side", kRobotCollisionGeometry.UMBRELLA_HEIGHT, -90.0));
    MechanismLigament2d bottomSide =
        rightSide.append(
            new MechanismLigament2d(
                "Umbrella Bottom Side", kRobotCollisionGeometry.UMBRELLA_LENGTH, -90.0));
  ...
  private void drawDriveBase() {
    ...
    MechanismRoot2d drivebaseRoot =
        mechanism.getRoot("Drivebase", drivebaseOrigin.getX(), drivebaseOrigin.getY());
    MechanismLigament2d leftSide =
        drivebaseRoot.append(
            new MechanismLigament2d(
                "DriveBase Left Side", kRobotCollisionGeometry.DRIVE_BASE.getYWidth(), 90.0));
    MechanismLigament2d topSide =
        leftSide.append(
            new MechanismLigament2d(
                "DriveBase Top Side", kRobotCollisionGeometry.DRIVE_BASE.getXWidth(), -90.0));
    MechanismLigament2d rightSide =
        topSide.append(
            new MechanismLigament2d(
                "DriveBase Right Side", kRobotCollisionGeometry.DRIVE_BASE.getYWidth(), -90.0));
    MechanismLigament2d bottomSide =
        rightSide.append(
            new MechanismLigament2d(
                "DriveBase Bottom Side", kRobotCollisionGeometry.DRIVE_BASE.getXWidth(), -90.0));
  ...
  private void drawMaxBounds() {
    ...
    MechanismRoot2d boundsRoot =
        mechanism.getRoot("MaxBounds", drivebaseOrigin.getX(), drivebaseOrigin.getY());
    MechanismLigament2d leftBottomSide =
        boundsRoot.append(
            new MechanismLigament2d(
                "MaxBounds Left Bottom Side",
                Units.inchesToMeters(12.0)
                    - ((kRobotCollisionGeometry.DRIVE_BASE.getXWidth() - Units.inchesToMeters(26.0))
                        / 2.0),
                180.0));
    MechanismLigament2d leftSide =
        leftBottomSide.append(
            new MechanismLigament2d("MaxBounds Left Side", Units.inchesToMeters(48.0), -90.0));
    MechanismLigament2d topSide =
        leftSide.append(
            new MechanismLigament2d(
                "MaxBounds Top Side", Units.inchesToMeters(26.0 + 24.0), -90.0));
    MechanismLigament2d rightSide =
        topSide.append(
            new MechanismLigament2d("MaxBounds Right Side", Units.inchesToMeters(48.0), -90.0));
    MechanismLigament2d rightBottomSide =
        rightSide.append(
            new MechanismLigament2d(
  ...
  public void updateCurrent(StemPosition currentPose) {
    ...
    // 0% = green, 100% = red
    Double percent =
        (currentPose.telescopeMeters - kStem.kTelescope.MIN_METERS)
