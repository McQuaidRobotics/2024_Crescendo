...
import igknighters.util.logging.CharacterizationLogger;
...
public class PivotReal extends Pivot {
  ...
  public PivotReal() {
    ...
    characterizationLogger =
        new CharacterizationLogger(
  ...
  public void periodic() {
    ...
    super.radiansPerSecond =
        -Units.rotationsToRadians(motorVelo.getValueAsDouble()) / kPivot.MOTOR_TO_MECHANISM_RATIO;
