...
public class ShooterReal extends Shooter {
  ...
  private final VelocityVoltage controlReq =
      new VelocityVoltage(0.0).withUpdateFreqHz(0).withEnableFOC(true);
  ...
  public double getSpeed() {
    return (super.radiansPerSecondRight + (super.radiansPerSecondLeft / kShooter.LEFT_MOTOR_DIFF))
        / 2.0;
  }

  @Override
  public double getTargetSpeed() {
    return (super.targetRadiansPerSecondRight
            + (super.targetRadiansPerSecondLeft / kShooter.LEFT_MOTOR_DIFF))
        / 2.0;
  }
  ...
  public void periodic() {
    ...
    FaultManager.captureFault(
        UmbrellaHW.LeftShooterMotor, veloSignalLeft, voltSignalLeft, currentSignalLeft);
