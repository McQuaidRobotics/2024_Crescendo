 ...
 *
 * <p>This allows you to hook onto to any of the robot mode functions and run your own code.
 *
 * <p>This also allows you to interupt the robot code in a way without the unit test thinking it
 * crashed.
 *
 * <pre><code>
 *
