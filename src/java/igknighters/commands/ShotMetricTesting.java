...
public class ShotMetricTesting {
  private static final TunableDouble shooterSpeed =
      TunableValues.getDouble("TestShooterSpeed", kControls.SHOOTER_RPM);
  private static final TunableDouble wristAngle =
      TunableValues.getDouble(
          "TestWristAngle", Units.radiansToDegrees(StemPosition.STOW.wristRads));
  private static final TunableDouble pivotAngle =
      TunableValues.getDouble(
          "TestPivotAngle", Units.radiansToDegrees(StemPosition.STOW.pivotRads));
  ...
  public static StemPosition testStemPose() {
    return StemPosition.fromDegrees(
        pivotAngle.value(), wristAngle.value(), StemPosition.STOW.telescopeMeters);
  }
