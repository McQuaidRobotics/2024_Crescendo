...
public class HigherOrderCommands {
                ...
                .until(
                    () -> {
                      ...
                      return pose.wristRads
                              > (StemPosition.INTAKE.wristRads + kWrist.MIN_ANGLE) / 2.0
  ...
  public static Command aimNotePass(
    ...
    return Commands.parallel(
        new TeleopSwerveTargetCmd(
            swerve, controller, localizer, kControls.PASS_LAND_LOCATION, true, 0.4),
        StemCommands.aimAtPassPoint(stem, kControls.PASS_LAND_LOCATION, false, localizer::pose));
  }
  ...
  public static class ShootSequences {
    ...
    public static Command autoAimShoot(
        ...
        Localizer localizer) {
      return Commands.parallel(
              HigherOrderCommands.aim(swerve, stem, controller, localizer),
              UmbrellaCommands.shoot(umbrella, () -> targetRpm(umbrella)))
    ...
    public static Command autoAimPassShoot(
        ...
        Localizer localizer) {
      return Commands.parallel(
              HigherOrderCommands.aimNotePass(swerve, stem, controller, localizer),
              UmbrellaCommands.shoot(umbrella, () -> targetRpm(umbrella)))
          .withName("AutoAimShoot");
    }
