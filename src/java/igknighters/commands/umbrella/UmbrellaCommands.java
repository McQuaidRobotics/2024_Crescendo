package igknighters.commands.umbrella;
...
public class UmbrellaCommands {
  ...
  public static Command stopShooter(Umbrella umbrella) {
    return umbrella.runOnce(() -> umbrella.spinupShooterToRPM(0)).withName("Stop Shooter");
  }
  ...
  public static Command waitUntilSpunUp(Umbrella umbrella, double rpm, double tolerance) {
    return umbrella
        .run(() -> umbrella.spinupShooterToRPM(rpm))
        .until(() -> umbrella.isShooterAtSpeed(tolerance))
  ...
  public static Command intake(Umbrella umbrella) {
    return umbrella
        .runEnd(() -> umbrella.runIntakeAt(-0.7, false), () -> umbrella.runIntakeAt(0.0, false))
  ...
  public static Command expell(Umbrella umbrella) {
    return umbrella
        .runEnd(() -> umbrella.runIntakeAt(1.0, true), umbrella::stopAll)
        .withName("Expell");
  }
  ...
  public static double defaultIdleRPM() {
    return Robot.isDemo()
        ...
        : DriverStation.isAutonomousEnabled()
            ? kControls.AUTO_SHOOTER_RPM
            : kControls.SHOOTER_IDLE_RPM;
  }

  /**
   * Will spin the shooter up to its idle speed, in demo mode the shooter will be stopped
   *
   * @param umbrella The umbrella subsystem
   * @return A command to be scheduled
   */
  ...
  /**
   * Will spin the intake inwards until a game piece is held, and spin the shooter up to its idle
   * speed
   *
   * @param umbrella The umbrella subsystem
   * @return A command to be scheduled
